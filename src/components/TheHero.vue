<template>
  <div class="hero-container">
    <div class="hero-content1-container">
    ...
    <div class="hero-content3-container">
      ...
      <div class="tools-intro-container">
        <div class="tools-intro1">
          ...
          <div>
            <p>透過house168的房屋變裝服務，我們利用最新的AI技術，</p>
            <p>將空置或髒亂的房屋重新裝扮，為您呈現出煥然一新的風貌</p>
            <p>無論是全新的成屋還是中古房屋，我們能夠重新設計裝潢，</p>
            <p>讓每個空間焕然一新。這不僅能吸引更多潛在買家的注意，</p>
            <p>還能加速房屋成交的速度，讓您的房地產業務更上一層樓。</p>
          </div>
        </div>
